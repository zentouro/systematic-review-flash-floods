...
summary <- data.frame("total" = nrow(bib_all), "accepted" = nrow(bib_accept), "geophysical" = nrow(bib_hydrology), "social" = nrow(bib_social), "geophysical and social" = nrow(bib_both))
